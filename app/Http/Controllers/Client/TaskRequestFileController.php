...
class TaskRequestFileController extends ClientBaseController
{
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('file')) {
            ...
            foreach ($request->file as $fileData){
                ...
                if($upload) {
                    $file = new TaskRequestFile();
                    $file->user_id = $this->user->id;
                    $file->task_id = $request->task_id;

                    $filename = Files::uploadLocalOrS3($fileData, 'task-files-requests/' . $request->task_id);
        ...
        $this->taskFiles = TaskRequestFile::where('task_id', $request->task_id)->get();
    ...
    public function destroy(Request $request, $id)
    {
        ...
        Files::deleteFile($file->hashname, 'task-files-requests/'.$file->task_id);
