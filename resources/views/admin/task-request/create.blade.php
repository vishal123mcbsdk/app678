                            ...
                            <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control"
                                                    ...
                                                    @foreach($projects as $project)
                                                         <option
                                                            @if($project->id == $taskRequests->project_id) selected @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" name="category_id"
                                                    ...
                                                    <option value="{{ $category->id }}"
                                                            @if($taskRequests->task_category_id == $category->id)
                                                            selected
                                                            @endif
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" name="description"
                                                      class="form-control summernote">{{ $taskRequests->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="start_date" id="start_date2" class="form-control" autocomplete="off" value="@if($taskRequests->start_date != '-0001-11-30 00:00:00' && $taskRequests->start_date != null) {{ $taskRequests->start_date->format($global->date_format) }} @endif">
                                    ...
                                    <div class="col-md-4" id="duedateBox">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="due_date" id="due_date2" class="form-control" autocomplete="off" value="@if($taskRequests->due_date != '') {{ $taskRequests->due_date->format($global->date_format) }} @endif">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group" style="padding-top: 25px;">
                                            <div class="checkbox checkbox-info">
                                                    <input id="without_duedate" @if($taskRequests->due_date == null) checked @endif  name="without_duedate" value="true"
                                                       type="checkbox">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        @if(is_null($taskRequests->project_id))
                                            @foreach($employees as $employee)
                                                ...
                                                @foreach ($taskRequests->users as $item)
                                            ...
                                            @endforeach
                                        @else
                                            @foreach($taskRequests->project->members as $member)
                                                @php
                                                    $selected = '';
                                                @endphp
