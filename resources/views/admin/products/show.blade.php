                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-6 b-r"> <strong>@lang('app.name')</strong> <br>
                                                <p class="text-muted">{{ (!is_null($product)) ? $product->name : '--' }}</p>
                                            </div>
                                            <div class="col-xs-6"> <strong>@lang('app.price')</strong> <br>
                                                <p class="text-muted">{{ (!is_null($product)) ? $product->price : '--'}}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-xs-6 b-r"> <strong>@lang('modules.productCategory.productCategory')</strong> <br>
                                                <p class="text-muted">{{($product->category != '') ? ucwords($product->category->category_name) :'--' }}</p>
                                            </div>
                                            <div class="col-xs-6 b-r"> <strong>@lang('modules.productCategory.productSubCategory')</strong> <br>
                                                <p class="text-muted">{{($product->subcategory != '') ? ucwords($product->subcategory->category_name) :'--' }}</p>
                                            </div>
