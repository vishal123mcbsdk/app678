            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12 p-r-0">
                        <nav>
                            <ul >
                                <li ><a href="{{ route('member.invoice-recurring.show', $invoice->id) }}"><span>@lang('app.invoiceRecurring') @lang('app.info')</span></a>
                                </li>
                                <li class="tab-current"><a href="{{ route('member.invoice-recurring.recurring-invoice', $invoice->id) }}"><span>@lang('app.recurringInvoices')</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
    ...
    $('body').on('click', '.reminderButton', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('member.all-invoices.payment-reminder',':id') }}";
