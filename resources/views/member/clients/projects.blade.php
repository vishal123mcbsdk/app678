                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li><a href="{{ route('member.notes.show',$client->id) }}" class="waves-effect"><i class="fa fa-sticky-note-o"></i> <span class="hide-menu">@lang('modules.projects.notes') </span></a> </li>
                            </ul>
                        </nav>
                    </div>
