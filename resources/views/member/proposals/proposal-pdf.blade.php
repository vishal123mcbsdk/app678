...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($proposal->items as $item)
            ...
            @if(!is_null($item->item_summary))
                <tr style="text-align: left;">
                    <td class="no"></td>
                    <td style="text-align: left;" class="item-summary" text-align="left" @if($invoiceSetting->hsn_sac_code_show) colspan="4" @else colspan="3" @endif>
                        {!! ($item->item_summary) !!}
                    </td>
                    <td class="unit"></td>
                </tr>
        ...
        <tr style="page-break-inside: avoid;" class="discount">
            ...
            <td class="qty">&nbsp;</td>
            @endif
            <td class="desc" colspan="2">@lang("modules.invoices.discount")</td>
