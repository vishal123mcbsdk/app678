...
<div class="modal-body">
    <div class="portlet-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group" style="padding-top: 25px;">
                            <div class="checkbox checkbox-info">
                                <input id="without_duedate_subtask" name="without_duedate" value="true" type="checkbox">
        ...
        <div class="form-actions">
            <button type="button" onclick="saveSubTaskWithFile()" class="btn btn-success"> <i class="fa fa-check"></i>
        ...
        $.easyAjax({
            ...
            success: function(response) {
                ...
                if (response.status == "success") {
                    $('#percentage-count').html(
                        `<span class="pull-right"><span class="donut">${response.data.completedSubtasks}/${response.data.totalSubTasks}</span> <span class="text-muted font-12">${response.data.percentageTaskCompleted}%</span></span>`
                        );

                    $('#subtask-count').text("@lang('modules.tasks.subTask')" + '(' + (response.data
                        .totalSubTasks) + ')');
