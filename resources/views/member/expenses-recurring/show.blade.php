...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            ...
            <a href="{{ route('member.expenses-recurring.edit',$expense->id) }}"
                    ...
                    <div class="white-box">
                        <div class="row">
                            <div class="col-md-11 p-r-0">
                                <nav>
                                    <ul >
                                        <li class="tab-current"><a href="{{ route('member.expenses-recurring.show', $expense->id) }}"><span>@lang('app.menu.expensesRecurring') @lang('app.info')</span></a>
                                        </li>
                                        <li><a href="{{ route('member.expenses-recurring.recurring-expenses', $expense->id) }}"><span>@lang('app.menu.expenses')</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
