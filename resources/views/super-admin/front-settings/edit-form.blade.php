        ...
        <div class="col-sm-12 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="feature_title" name="feature_title"
                    value="{{ $trFrontDetail->feature_title }}">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <textarea class="form-control" id="feature_description" rows="5"
                        name="feature_description">{{ $trFrontDetail->feature_description }}</textarea>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="price_title" name="price_title"
                    value="{{ $trFrontDetail->price_title }}">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <textarea class="form-control" id="price_description" rows="5"
                        name="price_description">{{ $trFrontDetail->price_description }}</textarea>
            </div>
        </div>
    </div>
