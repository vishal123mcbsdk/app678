...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href=" @if(isset($global->favicon_url)){{ $global->favicon_url}} @else '' @endif">
    {{--<link rel="manifest" href="{{ asset('favicon/manifest.json') }}">--}}
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content=" @if(isset($global->favicon_url)){{ $global->favicon_url}} @else '' @endif">
            ...
            <div class="col-md-12">
                <div class="white-box p-t-20">
                    {!! Form::open(['id'=>'createLead','class'=>'ajax-form','method'=>'POST']) !!}
                        <div class="form-body">
                            <div class="row">
                                @if(!is_null($ticketFormFields) && isset($ticketFormFields))
