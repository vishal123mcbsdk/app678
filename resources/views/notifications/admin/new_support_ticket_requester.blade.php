<li class="top-notifications">
    <div class="message-center">
        <a href="{{ route('admin.support-tickets.edit',  $notification->data['id']) }}">
            <div class="user-img">
                <span class="btn btn-circle btn-warning"><i class="ti-ticket"></i></span>
            </div>
            <div class="mail-contnet">
                <span class="mail-desc m-0">{{ __('email.newSupportTicketRequester.subject') . ' #' . $notification->data['id']}}</span>
